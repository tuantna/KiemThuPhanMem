...
namespace DoAnTotNghiep.BusinessLayer
{
    public class BLQuyen
    {
        ...
        public BLQuyen()
        {
            query = PhamMem.db.QUYENs;
        }
        #endregion

        #region Xử lý đọc dữ liệu
        public IList<QUYEN> DocQuyen()
        {
            return query.ToList();
        }
        //public IList<QUYEN> DocChucVuTheodieukien(string pDK)
        //{
        ...
        //    return true;
        //}
        //private bool KiemTraNhanVien(CHUCVU pCV)
        //{
