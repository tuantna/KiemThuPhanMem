...
namespace DoAnTotNghiep.BusinessLayer
{
    public class BLBanGiao
    {
        ...
        public BLBanGiao()
        {
            query = PhamMem.db.BANGIAOs;
        }
        #endregion

        #region Xử lý đọc dữ liệu
        public IList<BANGIAO> DocSoTheoDoi()
        {
            return query.ToList();
        }       
        ...
        //    return dh;
        //}
        public BANGIAO DocBanGiaoTheoNgay(DateTime pTBID)
        {
            return query.Where(BANGIAO => BANGIAO.NgayGiao == pTBID).FirstOrDefault();
        }
        ...
        //    return dh;
        //}
        public IList<BANGIAO> DocBanGiaoTheiIDPB(int pTBID)
        {
            IList<BANGIAO> dh = query.Where(x => x.PhongBanID == pTBID).ToList();
            return dh;
        }
        ...
        public IList<BANGIAO> Them(BANGIAO pTB)
        {
           // if (ThietBiHopLe(pTB))
            //{
